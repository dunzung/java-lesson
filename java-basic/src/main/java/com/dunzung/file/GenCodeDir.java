...
public class GenCodeDir {
    ...
    public static void main(String args[]) throws Exception {
        //String rootDir = System.getProperty("user.dir") + "/java-basic/src/main/java";
        String rootDir = "D:\\wrks\\portal-git\\unicom-portal-pbm-service/src/main/java";
        System.out.println(generate(rootDir, new HashSet<>(Arrays.asList(".idea", "target", ".git")), true, true));
